...
export class IdeaNodeComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    if(this.numVotes < 0) {
      document.getElementById("numVotes").style.color = "#f7408d";
    }
  }

  upvote() {
    this.numVotes++;
    document.getElementById("arrowUp").style.stroke = "#40f7aa";
    document.getElementById("arrowDown").style.stroke = "black";
    if(this.numVotes >= 0) {
      document.getElementById("numVotes").style.color = "black";
    }
  }

  downvote() {
    this.numVotes--;
    document.getElementById("arrowUp").style.stroke = "black";
    document.getElementById("arrowDown").style.stroke = "#f7408d";
    if(this.numVotes < 0) {
      document.getElementById("numVotes").style.color = "#f7408d";
    }
  }
